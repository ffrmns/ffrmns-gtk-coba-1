/// Dari gtk3-demo
#ifndef GTK3DEMO_ASSISTANT
#define GTK3DEMO_ASSISTANT
#include <gtk/gtk.h>
  ...
  if (!assistant)
    {
      ...
      /// Dikomen karena tidak mengambil inputan
...
// Tambahan main dari https://stackoverflow.com/questions/2749329/how-do-i-run-gtk-demos
//argc dibuat nol, argv dibuat NULL
int
main_gtk3demo_assistant()
{
  GtkWidget *window;
  gtk_init(0, NULL);
  window = do_assistant(NULL);
